  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Router>
        <Layout>
          <Routes>
            <Route path="/" element={<GuidedJourney />} />
            ...
            <Route path="/guest/activity-selection" element={<ActivitySelection />} />
            <Route path="/guest/trip-map" element={<TripMap />} />
            <Route path="/guest/destination-activities" element={<DestinationActivities />} />
            <Route path="/guest/onboard-upgrades" element={<OnboardUpgrades />} />
